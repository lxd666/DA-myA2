function [acc,Res_performance] = JDA(X_src,Y_src,X_tar,Y_tar,options)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	for i = 1 : T
        ...
        knn_model = fitcknn(Zs',Y_src,'NumNeighbors',n_neighbors);
...
clab=[1,2];
Res_performance = performance(Y_tar,Y_tar_pseudo,[],clab);  
